...
def change_new_lane(sim,cmds_nodes,img2):
	...
	if cmds_nodes == 20:
		...
		if package_name != None :
			...
			sim.callScriptFunction("deliver_package", childscript_handle, package_name, Storage.cmds_checkpoints[Storage.cmds_checkpoints_state])
...
def yellowchecker(sim,jointHandle_l,jointHandle_r):
	...
	if Storage.yellow[-2] != 0 and Storage.yellow[-1] < Storage.yellow[-2]  :
		vel = 0
